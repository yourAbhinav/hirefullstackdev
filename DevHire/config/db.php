...
try {
	...
	// Load shared admin/platform helpers so maintenance enforcement can read platform settings.
	require_once __DIR__ . '/../includes/admin_helpers.php';

	// Create logs/error.log eagerly so errors during early bootstrap are captured
	ensureLogPath();

	// Enforce maintenance mode for public requests before the rest of the page renders.
	if (php_sapi_name() !== 'cli') {
